...
The current index in ds is positioned at overlapping member." },
 ...
 // {"IsWeak",	(PyCFunction)rpmds_IsWeak,	METH_NOARGS,  "ds.IsWeak() -- Return whether the dependency is weak."},
 {"IsRich",	(PyCFunction)rpmds_IsRich,	METH_NOARGS,
  "ds.IsRich() -- Return whether the dependency is rich."},
// Fulup  {"IsReverse",	(PyCFunction)rpmds_IsReverse,	METH_NOARGS,  "ds.IsReverse() -- Return whether the dependency is reversed."},
 {NULL,		NULL}		/* sentinel */
};
