# red-dnf completion                                          -*- shell-script -*-
# 
# This file was taken from dnf and modified for red-dnf
#
...
__dnf_repopkgs_subcmds="
    red-install red-list red-remove red-manager red-search 
    red-listrepo red-repolist red-rlist
    rin rls rlr rrm rmg rse
    check-update
    info install
    list
    move-to
...
_reddnf()
{
    ...
    *)
    ...
    in|install*|localinstall|red-install|rin)
        _dnf_show_packages $command
        ;;
    ...
    rm|remove*|erase*|rrm|red-remove)
        _dnf_show_packages $command
        extra_options="--oldinstallonly --duplicates --duplicated"
        ;;

    repoinfo|repolist|red-listrepo|red-repo-list|rlp|red-rlist)
