...
static const cyaml_schema_field_t ConfigSchema[] = {
    ...
    CYAML_FIELD_ENUM("share_all", CYFLAG_PTR|CYFLAG_CASE|CYFLAG_OPT, redConfTagT, share.all, redConfOptStrings, CYAML_ARRAY_LEN(redConfOptStrings)),
    CYAML_FIELD_ENUM("share_user", CYFLAG_PTR|CYFLAG_CASE|CYFLAG_OPT, redConfTagT, share.user, redConfOptStrings, CYAML_ARRAY_LEN(redConfOptStrings)),
    CYAML_FIELD_ENUM("share_cgroup", CYFLAG_PTR|CYFLAG_CASE|CYFLAG_OPT, redConfTagT, share.cgroup, redConfOptStrings, CYAML_ARRAY_LEN(redConfOptStrings)),
    CYAML_FIELD_ENUM("share_net", CYFLAG_PTR|CYFLAG_CASE|CYFLAG_OPT, redConfTagT, share.net, redConfOptStrings, CYAML_ARRAY_LEN(redConfOptStrings)),
    CYAML_FIELD_ENUM("share_pid", CYFLAG_PTR|CYFLAG_CASE|CYFLAG_OPT, redConfTagT, share.pid, redConfOptStrings, CYAML_ARRAY_LEN(redConfOptStrings)),
    CYAML_FIELD_ENUM("share_ipc", CYFLAG_PTR|CYFLAG_CASE|CYFLAG_OPT, redConfTagT, share.ipc, redConfOptStrings, CYAML_ARRAY_LEN(redConfOptStrings)),
    CYAML_FIELD_ENUM("share_time", CYFLAG_PTR|CYFLAG_CASE|CYFLAG_OPT, redConfTagT, share.time, redConfOptStrings, CYAML_ARRAY_LEN(redConfOptStrings)),
