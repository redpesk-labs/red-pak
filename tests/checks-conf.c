...
#define RMDIR(path) { NULL,NULL,NULL,NULL,path,0,0,0 }
    ...
    TEST("/tmp", NULL, "alias", BIGNAME(REDNODE_FACTORY_PATH_LEN), NULL, 0, RednodeFactory_Mode_Default, RednodeFactory_Error_Template_Too_Long),
    TEST("/tmp", NULL, "alias", "not-existing", NULL, 0, RednodeFactory_Mode_Default, RednodeFactory_Error_No_Template),
    TEST("/tmp", NULL, "alias", NULL, "not-existing", 0, RednodeFactory_Mode_Default, RednodeFactory_Error_No_Template),
    TEST("/tmp", NULL, "alias", tempname, NULL, 0, RednodeFactory_Mode_Default, RednodeFactory_Error_Loading_Template),
    TEST("/tmp", NULL, "alias", NULL, tempname, 0, RednodeFactory_Mode_Default, RednodeFactory_Error_Loading_Template),
